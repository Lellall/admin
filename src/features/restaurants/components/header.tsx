...
const HeaderProfile = () => {
    return (
        <HeaderWrapper>
            <BackgroundImage src="https://plus.unsplash.com/premium_photo-1670601440146-3b33dfcd7e17?q=80&w=2738&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Header Profile" />
            <GradientOverlay />

            <BottomBox>

                <h1 className="text-[#092d2b] text-2xl  font-light tracking-wider leading-tight">
                    Cafe Dimanche
                </h1>
