...
const RestaurantDashBoard = () => {
  ...
  return (
    <>
      <Container>
        <ShopCard imgUrl={CardIcon} title="Total" amount={20000} amountInPercentage={"+5%"} />
        <ShopCard imgUrl={CardIcon} title="Inventory" amount={20000} amountInPercentage={"+5%"} />
        <ShopCard imgUrl={CardIcon} title="Invoices" amount={20000} amountInPercentage={"+5%"} />
        <ShopCard imgUrl={CardIcon} title="Orders" amount={20000} amountInPercentage={"+5%"} />
      </Container>
