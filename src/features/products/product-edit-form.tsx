  ...
  return (
    <Container>
      <RowContainer>
        ...
        <ColumnContainer>
          <Label>Price:</Label>
          <PriceInput type="number" min="0" value={price} onChange={handlePriceChange} placeholder="Price" />
        </ColumnContainer>
        <ColumnContainer style={{ width: '100%' }}>
          <Label>Description:</Label>
          <DescriptionInput value={description} onChange={handleDescriptionChange} placeholder="description" />
        </ColumnContainer>
        <ColumnContainer>
